#!/usr/bin/env python3
"""Standalone EEF node runner (installed by the bootstrap into C:/eefn).

Reads config.json next to this file (written by bootstrap_eef.py), then connects
to the coordinator over the ordered endpoint list (Radmin primary → Playit
secondary). stdlib + cryptography only.
"""
